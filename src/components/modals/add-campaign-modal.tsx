...
export const AddCampaignModal: React.FC<AddCampaignModalProps> = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.rules.trim()) {
      newErrors.rules = "Campaign rules are required";
    }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up a new recipe campaign to engage your community
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 px-8 py-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <label
                htmlFor="cover-image"
                className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#DC143C] transition-colors"
              >
                {coverImage ? (
                  <img
                    src={coverImage}
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-4 py-2 text-gray-700 border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#DC143C]/20 focus:border-[#DC143C] placeholder:text-gray-400 ${
                errors.rules ? "border-red-500" : "border-gray-200"
              }`}
            />
            {errors.rules && (
